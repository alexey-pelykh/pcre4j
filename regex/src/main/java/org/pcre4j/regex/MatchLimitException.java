 ...
 * <p>
 * The specific limit that was exceeded can be determined via {@link #getErrorCode()}:
 * <ul>
 ...
 */
public class MatchLimitException extends RuntimeException {

    /**
     * The PCRE2 error code that caused this exception.
     */
